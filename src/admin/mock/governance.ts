...
export const mockRoleDefinitions: AdminRoleDefinition[] = [
  {
    ...
    permissions: {
      ...
      sos: ["view", "acknowledge", "resolve"],
      incidents: ["view", "assign", "acknowledge", "resolve"],
  ...
  },
  {
    ...
    description: "Preview role for SOS and incident review only.",
    assignedUserCount: 1,
    readOnly: true,
    permissions: {
      dashboard: ["view"],
...
export const mockAuditLogs: AdminAuditLog[] = [
  {
    ...
    userPlaceholder: "Demo Super Administrator",
    ...
    details: "Demonstration audit event. Production audit logging is not connected.",
  },
  {
    isDemo: true,
    id: "al-002",
    reference: "YHP-AUD-DEMO-0002",
    occurredAt: "2026-07-14T09:42:00Z",
    occurredDate: "2026-07-14",
    userPlaceholder: "Demo Safety Officer",
    action: "Acknowledged test alert locally",
    module: "sos",
    recordReference: "YHP-SOS-DEMO-0002",
    outcome: "successful_preview",
    ipPlaceholder: "192.0.2.xxx",
    devicePlaceholder: "Preview browser",
    details: "Local preview action only. No emergency response was dispatched.",
  },
  {
    isDemo: true,
    id: "al-003",
    ...
    userPlaceholder: "Demo Content Manager",
...
export const mockSettingsSnapshot: AdminSettingsSnapshot = {
  ...
  safety: {
    "SOS mode": "Preview only",
    "Emergency contacts": "Awaiting authorised content",
  },
  media: {
