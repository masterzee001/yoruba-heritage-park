...
const migrations = [
  ...
  migration("006_payment_campaign_setup.sql"),
];
...
const paymentCampaignSetupSchema = read("database/migrations/006_payment_campaign_setup.sql");
const seeds = [
...
-- Approved payment campaign setup schema.
${paymentCampaignSetupSchema}
